...
class TestAdminLogin:
    ...
    # 测试用例：登录功能
    @pytest.mark.parametrize("case_name,user,pwd,code,exp_el,expect", read_json("admin_login_data"))
    def test01_login_abnormal(self, case_name, user, pwd, code, exp_el, expect):
    ...
    def test02_login_suc(self):
        ...
        with allure.step("测试步骤二：断言"):
            ...
            assert is_suc
        allure.attach(self.driver.get_screenshot_as_png(), name="登录成功截图",
